...
export const JOB_PAYLOADS = Object.freeze({
  "discovery.run": Object.freeze({ role: "worker-discovery", version: 1, schema: z.object({ queryGroup: nonempty, requestedBy: uuid.nullable() }).strict() }),
  ...
  "analysis.run": Object.freeze({ role: "worker-analysis", version: 1, schema: z.object({ datasetVersionId: uuid, marketSnapshotId: uuid, mappingId: uuid }).strict() }),
  "chain.publish": Object.freeze({ role: "worker-chain", version: 1, schema: z.object({ packageId: uuid }).strict() }),
